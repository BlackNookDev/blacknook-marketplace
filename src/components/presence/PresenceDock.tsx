...
export default function PresenceDock() {
  ...
  return (
    <button
      ...
      className="fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full border border-white/10 bg-zinc-900/75 py-1.5 pl-1.5 pr-3 shadow-[0_8px_32px_rgba(0,0,0,0.32)] backdrop-blur-xl transition-[border-color,transform] hover:scale-[1.02] hover:border-emerald-400/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-400/50 active:scale-[0.98]"
